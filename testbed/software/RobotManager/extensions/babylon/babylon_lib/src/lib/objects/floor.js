...
import {adjustMaterialBrightness, getBabylonColor3, loadTexture} from "../babylon_utils";
import {
    CreateTiledGround,
    StandardMaterial,
    Texture,
    ...
    constructor(id, scene, config = {}) {
        ...
        this.mesh = MeshBuilder.CreateGround(
            id + '_ground',
            {
                ...
                subdivisions: this.config.subdivisionsX,
            },
            this.scene
        );
        ...
        if (this.config.texture) {
            ...
            mat.diffuseTexture = new Texture(texUrl, this.scene);
        ...
        // Ensure no emissive so shadows are visible
        mat.emissiveColor = getBabylonColor3([0, 0, 0]);
