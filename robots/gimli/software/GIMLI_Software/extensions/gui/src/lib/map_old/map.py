...
class Map:
    ...
    def __init__(self,
        ...
        default_options = {
            ...
            'background_color': 'transparent',  # 'transparent' or a color like [0.95, 0.95, 0.95] or (0.95, 0.95, 0.95)
            ...
            'grid_border_width': 2,
            'grid_ticks_color': [0.5, 0.5, 0.5],  # Color of the ticks on the grid lines
        }
