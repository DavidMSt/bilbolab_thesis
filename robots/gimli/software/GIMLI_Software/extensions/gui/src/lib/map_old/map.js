...
class GridMap {
    constructor(mapContainer, config = {}, rootPayload = null) {
        ...
        this.gridLineColor = getColor(this.config.grid_line_color);
        this.tickLabelColor = getColor(this.config.grid_ticks_color);

        // // 4) background and grid/tick colors
        this.canvas.style.backgroundColor = getColor(this.config.background_color);
...
class GridMapContainer {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    handleAdd(data) {
        this.map._handleAddMessage(data);
    }
