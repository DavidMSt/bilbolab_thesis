...
from core.utils.plotting import run_periodic, safe_close, new_figure_agg, quick_line_plot_data_uri, fig_to_data_uri, \
    save_figure
from core.utils.time import delayed_execution, setInterval
...
from extensions.gui.src.lib.plot.realtime.rt_plot import JSPlotTimeSeries, ServerMode, UpdateMode
from extensions.gui.src.lib.plot.realtime.rt_plot_widget import PlotWidget
...
def main():
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # Buttons
    button_1 = Button(id='button1', text='Button 1', color=[0.4, 0, 0], )
    page_buttons.addWidget(button_1, width=2, height=2, column=49)

    button_2 = Button(id='button2', text='Color Change', config={'color': [1, 0, 0, 0.2]})
    ...
    page_data.addWidget(plot_widget_1, width=12, height=10, row=8)

    plot_widget_2 = PlotWidget(widget_id='plot_widget_2', title='Plot 2',
                               server_mode=ServerMode.EXTERNAL,
                               update_mode=UpdateMode.CONTINUOUS)

    # Create another dataseries
    ...
    dataseries_3 = JSPlotTimeSeries(timeseries_id='ds3',
                                    ...
                                    color=random_color_from_palette('pastel'),
                                    y_axis_side='right', )
    dataseries_3.setValue(3.14)
    plot_widget_2.plot.addTimeseries(dataseries_2)
    plot_widget_2.plot.addTimeseries(dataseries_3)

    page_data.addWidget(plot_widget_2, width=12, height=10, roèw=8)
    ...
    group_button_1 = Button(id='group_button_1', text='GP 1', config={'color': random_color_from_palette('dark')})
    ...
    group_button_2 = Button(id='group_button_2', text='GP2', color=[0.3, 0, 0])
    ...
    tbpg3 = Button(id='tbpg3', text='TBPG3', color=[0.3, 0, 0])
    ...
    def add_item_to_page_3(*args, **kwargs):
        button_test = Button(id='tbpg4', text='TBPG4', color=[0.3, 0, 0.3])
    ...
    btn885 = Button(id='btn885', text='A', color=[0.3, 0, 0])
    ...
    # ==================================================================================================================
    # Popups and Callouts
    button_popup_open_1 = Button(id='button_popup_open_1', text='Open Dialog')
    ...
    def create_dialog_popup(*args, **kwargs, ):
        ...
        dialog_popupbtn1 = Button(id='dialog_popupbtn1', text='Close',
    ...
    def create_window_popup(*args, **kwargs, ):
        ...
        window_popupbtn1 = Button(id='window_popupbtn1', text='Close',
                                  config={'color': random_color_from_palette('dark')})
    ...
    button_popup_open_2 = Button(id='button_popup_open_2', text='Open Window')
    ...
    button_callout_1 = Button(id='button_callout_1', text='INFO Callout')
    ...
    button_callout_2 = Button(id='button_callout_2', text='WARNING Callout')
    ...
    # directory_widget = DirectoryWidget(widget_id='directory_widget', directory='/Users/lehmann/Desktop')
    ...
    gui_function_button_1 = Button(id='gui_function_button_1', text='Execute Function', )
    ...
    contextmenu_button = Button(id='contextmenu_button', text='Context Menu')
    ...
    while True:
        ...
        dataseries_2.setValue(random.random() * 2 - 1)
