...
from robot.estimation.optitrack.lib.optitrack import RigidBodySample
...
class TrackedFRODO:
    ...
    origin: Optional["TrackedOrigin"] = None

    callbacks: "TrackedFRODO_Callbacks"
    events: "TrackedFRODO_Events"

    # === INIT =========================================================================================================
    def __init__(self, id: str, definition: "TrackedFRODO_Definition", origin: Optional["TrackedOrigin"] = None):
        self.id = id
        self.definition = definition
        ...
        self._window_duration: float = 0.5  # slightly longer for stability at high-rate input
